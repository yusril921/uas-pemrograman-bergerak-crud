package co.dcc.registrasipesertaworkshop.adapter;
...
import co.dcc.registrasipesertaworkshop.R;
...
import co.dcc.registrasipesertaworkshop.widget.LetterTile;
...
public class ContactListAdapter extends RecyclerView.Adapter<ContactListAdapter.ContactHolder>{
    ...
    public void onBindViewHolder(ContactHolder holder, int position) {
        ...
        holder.phone.setText("No.HP : "+contact.getPhone());
        holder.email.setText("Email : "+contact.getEmail());
    }
